  ...
  if (!code) {
    ...
    res
      ...
      .send({
        ...
        token:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywiaWF0IjoxNjgxMDg0NDkzLCJleHAiOjE2ODExNzA4OTN9.ZJcCAd3nYajITtpbDvDkvcKnOR3P8Xew-S4olUc5Oh8",
      })
      .status(200);
    ...
    //   });
    //   //email send with code
    //   res.send({ user: query, token: token }).status(200);
    // }
  }
};
